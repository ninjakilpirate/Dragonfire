...
echo "\$instanceFilter.Query = \"select * from Win32_ProcessStartTrace where ProcessName='$exe'\"" >> $tgt
...
echo "\$instanceConsumer.CommandLineTemplate  = \"wmic process where name='$exe' delete\"" >> $tgt
